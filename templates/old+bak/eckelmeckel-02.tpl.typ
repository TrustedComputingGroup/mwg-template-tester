  ...
  if meas.height < 2in {
    block(
      ...
      [
        ...
        #block(
          [
            #v(-1em)
            #text([\u{1f6c8} ~ ] + kind, font: font_head_face, weight: "bold")
    ...
    block(
      ...
      [
        ...
        #block(
          [
            #v(-1em)
            #text([\u{1f6c8} ~ Start of ] + kind, font: font_head_face, weight: "bold")
          ],
          width: 100%,
          inset: (left: 10pt),
        )
    ...
    block(
      ...
      [
        #block(
          [
            #text([\u{1f6c8} ~ End of ] + kind, font: font_head_face, weight: "bold")
            #v(-0.8em)
          ],
          width: 100%,
          inset: (left: 10pt),
